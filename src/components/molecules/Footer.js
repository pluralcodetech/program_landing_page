  ...
  return (
    <div className="pad pt-5 foot w-100 d-flex flex-column flex-lg-row gap-5 gap-lg-0 justify-content-between">
      <div className="footf">
        ...
        <p className="pt-4 py-2 foottp">Acquire tech skills to build a borderless career.</p>
      ...
      <div className="w-100 row foottwo m-0 justify-content-between  justify-content-lg-start pb-lg-5">
        <div className="p-0 col-sm-5 smww col-md-4 col-lg-3 d-flex flex-column gap-2">
          <h5 className="">Top Courses</h5>
          <Link to="/#cert">Data Analytics</Link>
          <Link to="/#cert">Business Analytics</Link>
          <Link to="/#cert">Full-Stack Development</Link>
          <Link to="/#cert">Front-End Development</Link>
          <Link to="/#cert">Cloud Computing</Link>
