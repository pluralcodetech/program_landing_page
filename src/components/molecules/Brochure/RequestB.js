    ...
    <div className="pad">
      <div className="row align-items-center">
        <div className="col-sm-12 col-md-12 col-lg-6">
          <h1 className="text-white boldad szb">
            Request <span className="ptcolor boldad ">Our Brochure</span> &{" "}
            <span className="ptcolor boldad">Payment Plan</span>
          </h1>
          <p className="text-white normalad pt-3">
            Provide us your contact details to receive an updated copy of
            student brochure, curriculum and payment plan.. Once this is done,
            you will receive an email with the details and one of our Student
            Advisors will reach out for a 15 min call to walk you through all
            requirements and answer your questions.
          </p>

          <div className="d-none d-lg-block m-0">
            <Image src={circle} className="imgba2" />
          </div>
        </div>
