...
const WhySection = () => {
  return (
    <div className="pt-1 pt-lg-5  whh enbg">
      ...
      <div className="pad w-100 d-flex flex-column flex-lg-row flex-column-reverse gap-4 justify-content-between" data-aos="fade-up" data-aos-duration="2000">
        <Why
          h2="
        Flexible Learning
        "
        ...
        <div className="w-100 rounded-4 why" data-aos="zoom-in-up" data-aos-duration="2000">

        <Logo src={pix} className="whyimg"/>
        </div>
      </div>
      <div className="pad w-100 d-flex flex-column yh flex-lg-row gap-4 justify-content-between" data-aos="zoom-in-up" data-aos-duration="2000">
        <Why
          h2="Career Labs"
